...
import com.example.effectivemobile.presentation.mainscreen.MainFragmentDirections
...
class RouterImpl
    ...
    constructor(
        ...
        private fun moveToChoiceCountry(
            title: String,
            bottomTitle: String,
        ) {
            navController?.navigate(
                DialogSearchDirections.actionDialogSearchToChoiceCountryFragment(title = title, bottomTitle = bottomTitle),
            )
        }

        private fun moveToAllTickets(
            title: String,
            bottomTitle: String,
        ) {
        ...
        private fun openDialogSearch(title: String) {
            navController?.navigate(MainFragmentDirections.actionMainFragmentToDialogSearch(title))
        }
